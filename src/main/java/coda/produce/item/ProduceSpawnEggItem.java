...
public class ProduceSpawnEggItem extends SpawnEggItem {
    public static final List<ProduceSpawnEggItem> UNADDED_EGGS = new ArrayList<ProduceSpawnEggItem>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public ProduceSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier, final int primaryColor, final int secondaryColor, final Properties properties) {
