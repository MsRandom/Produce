...
public class ProduceCaveWorldCarver extends WorldCarver<ProbabilityConfig> {

    public ProduceCaveWorldCarver(Codec<ProbabilityConfig> p_i231917_1_) {
        super(p_i231917_1_, 1);
        this.replaceableBlocks = ImmutableSet.of(Blocks.GRASS, ProduceBlocks.BROCKOLI_BLOCK, ProduceBlocks.CHARRED_BROCKOLI_BLOCK, Blocks.AIR, Blocks.CAVE_AIR);
    }
